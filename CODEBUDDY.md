...
> 2. **版本迭代叙事** → [CHANGELOG.md](CHANGELOG.md)（v2 → v7.0 各轮新增/推翻/修复）
...
python -m pytest tests/ -q       # 运行测试套件（当前 963 用例）
