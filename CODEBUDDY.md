...
> 2. **版本迭代叙事** → [CHANGELOG.md](CHANGELOG.md)（v2 → v7.4 各轮新增/推翻/修复）
...
python -m pytest tests/ -q       # 运行后端测试套件（当前 1028 用例 + 1 live_llm 抽检默认跳过）
